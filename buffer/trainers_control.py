...
from src.tasks.vizdoom_two_colors import create_vizdoom_two_colors
...
def get_env_initializers(env_config):
    ...
    elif env_config['task']=='vizdoom_two_colors':
        env_fn=lambda: create_vizdoom_two_colors(env_config['env_name'])
        eval_env_fn=lambda: create_vizdoom_two_colors(env_config['env_name'])
        repr_fn=atari_conv_repr_model()
        return env_fn,eval_env_fn,repr_fn
