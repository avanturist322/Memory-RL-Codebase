...
from environments.POPGym.deck import Deck
from environments.POPGym.env import POPGymEnv
...
class RepeatPrevious(POPGymEnv):
    ...
    def __init__(self, num_decks=1, k=4):
        ...
        assert self.deck.num_cards > k, "k cannot be more than 52 * num_decks"
...
class RepeatPreviousMedium(RepeatPrevious):
    def __init__(self):
        super().__init__(num_decks=2, k=30)


class RepeatPreviousHard(RepeatPrevious):
    def __init__(self):
        super().__init__(num_decks=3, k=60)