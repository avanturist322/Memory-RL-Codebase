...
import numpy as np
import yaml
from key_door import curriculum_env, spatial_keys_env
...
TEST_MAP_PATH = os.path.join(
    FILE_PATH, "spatial_keys_test_map_files", "spatial_keys_sample_map.txt"
)
TEST_MAP_YAML_PATH = os.path.join(
    FILE_PATH, "spatial_keys_test_map_files", "spatial_keys_sample_map.yaml"
)
TEST_MAP_YAML2_PATH = os.path.join(
    FILE_PATH, "spatial_keys_test_map_files", "spatial_keys_sample_map2.yaml"
)
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        self._tabular_env = spatial_keys_env.SpatialKeysEnv(
        ...
        self._pixel_env = spatial_keys_env.SpatialKeysEnv(
            map_ascii_path=TEST_MAP_PATH,
            map_yaml_path=TEST_MAP_YAML_PATH,
