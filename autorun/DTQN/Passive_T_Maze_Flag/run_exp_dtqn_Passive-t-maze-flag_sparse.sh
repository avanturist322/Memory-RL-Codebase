...
config_list=(
            "/opt/Memory-RL-Codebase/configs/DTQN_configs/Passive_T_Maze_Flag/Sparse/Passive_T_Maze_Flag_LONG_TERM.yaml"
            "/opt/Memory-RL-Codebase/configs/DTQN_configs/Passive_T_Maze_Flag/Sparse/Passive_T_Maze_Flag_SHORT_TERM.yaml"
)

session_name="dtqn_Passive_T_Maze_Flag_sparse2"
