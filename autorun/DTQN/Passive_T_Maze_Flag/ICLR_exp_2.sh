...
config_list=(
    '/opt/Memory-RL-Codebase/configs/DTQN_configs/Passive_T_Maze_Flag/Dense/ICLR_exp_2/Passive_T_Maze_Flag_LONG_SHORT_TERM.yaml'
)

session_name="DTQN_ICLR_exp_2_run_4"
