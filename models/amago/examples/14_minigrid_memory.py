...
from amago.envs.builtin.minigrid_memory import MinigridMemoryGymEnv
#np.random.seed(seed)
...
def add_cli(parser):
    ...
    parser.add_argument("--env_length", type=int, default=21)
...
if __name__ == "__main__":
    ...
    for trial in range(args.trials):
        ...
        make_train_env = lambda: MinigridMemoryGymEnv(args.env, args.horizon, args.env_length) # 'MiniGrid-MemoryS13Random-v0'
...
"""
 ython3 models/amago/examples/14_minigrid_memory.py --env 'MiniGrid-MemoryS13Random-v0' --env_length 21 --parallel_actors 24 --trials 3 --epochs 200 --dset_max_size 5_000 --memory_layers 3 --memory_size 256 --gpu 0 --run_name amago_minigrid_memory_h95 --buffer_dir checkpoints/amago --ckpt_interval 20 --val_interval 20 --traj_encoder transformer --horizon 95 --traj_save_len 95 --max_seq_len 95 --no_log
"""
