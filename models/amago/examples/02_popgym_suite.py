...
"""
python3 models/amago/examples/11_doom.py --env ViZDoom-Two-Colors --parallel_actors 24 --trials 3 --epochs 500 --dset_max_size 80_000 --memory_layers 3 --memory_size 256 --gpu 0 --run_name amago_test_popgym --buffer_dir checkpoints/amago --ckpt_interval 5
"""