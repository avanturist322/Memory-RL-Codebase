...
from amago.envs.builtin.memory_maze import MemoryMazeGymEnv
#np.random.seed(seed)
...
def add_cli(parser):
    ...
    parser.add_argument("--traj_save_len", type=int, default=1000)
...
if __name__ == "__main__":
    ...
    for trial in range(args.trials):
        ...
        make_train_env = lambda: MemoryMazeGymEnv(args.env, args.horizon) # 'memory_maze:MemoryMaze-9x9-v0'
...
"""
 python3 models/amago/examples/12_memory_maze.py --env memory_maze:MemoryMaze-9x9-v0 --parallel_actors 24 --trials 3 --epochs 500 --dset_max_size 5_000 --memory_layers 3 --memory_size 256 --gpu 0 --run_name amago_doom_h2100 --buffer_dir checkpoints/amago --ckpt_interval 20 --val_interval 20 --traj_encoder transformer --horizon 1000 --traj_save_len 1000 --max_seq_len 1000
"""
